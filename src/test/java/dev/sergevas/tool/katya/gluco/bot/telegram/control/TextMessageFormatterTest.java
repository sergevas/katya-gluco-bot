...
class TextMessageFormatterTest {
    ...
    void testFormatUpdate() {
        assertEquals("7.2 " + EmojiParser.parseToUnicode(":arrow_right:") + " 00:07 \u1D41",
                TextMessageFormatter.formatUpdate(new XDripReadingContext(new SensorReading(Instant.parse("2025-04-14T21:07:40.688Z"),
    ...
    void testFormat() {
        assertEquals("7.2 " + EmojiParser.parseToUnicode(":arrow_right:"),
                TextMessageFormatter.format(new XDripReadingContext(new SensorReading(Instant.parse("2025-04-14T21:07:40.688Z"),
