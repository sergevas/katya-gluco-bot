...
class XDripReadingTest {

    @Test
    void toFormattedString() {
        assertEquals("7.2 " + EmojiParser.parseToUnicode(":arrow_right:"),
                new XDripReading(Instant.parse("2025-04-14T21:07:40.688Z"), 7.214927129235995, FLAT)
                        .toFormattedString());
        assertEquals("7.0 " + EmojiParser.parseToUnicode(":arrow_down:"),
                new XDripReading(Instant.parse("2025-04-14T21:07:40.688Z"), 7.02, SINGLE_DOWN)
                        .toFormattedString());
    }
}
